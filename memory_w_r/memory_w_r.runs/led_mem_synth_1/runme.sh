...
HD_PWD='C:/Users/Administrator/Desktop/memory_w_r/memory_w_r.runs/led_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_mem.tcl
