...
HD_PWD='F:/Êý×ÖÂß¼­ÊµÑé/flowing_water_lights/flowing_water_lights.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flowing_water_lights.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flowing_water_lights.tcl
